...
public class BaseConfiguration
{
	...
	public void login() {
		...
		loginobj.getLoginlink().click();
		loginobj.getEmailTextfield().sendKeys("vickypr1998@gmail.com");
		loginobj.getPasswordTextfield().sendKeys("Vicky@12");
